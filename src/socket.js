...
const connect = function (host) {
  let url = "ws://" + host + "/qlcplusWS";
  ...
  websocket.onmessage = function (ev) {
    ...
    // // alert(ev.data);
    // let msgParams = ev.data.split("|");
    // let obj = document.getElementById(msgParams[0]);
    ...
    //   let labelObj = document.getElementById("slv" + msgParams[0]);
    //   labelObj.innerHTML = msgParams[3];
    // } else if (msgParams[1] === "CUE") {
    //   setCueIndex(msgParams[0], msgParams[2]);
    //   let playBbj = document.getElementById("play" + msgParams[0]);
    //   if (msgParams[2] === "-1") {
